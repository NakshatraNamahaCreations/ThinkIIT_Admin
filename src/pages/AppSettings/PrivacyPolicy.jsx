  ...
  const [rows, setRows] = useState([
    {
      ...
      description:
        "This privacy policy explains how student data is handled...",
      createdAt: "2023-06-26",
    },
    {
      id: 2,
      title: "Privacy Policy for Teachers",
      description:
        "This privacy policy explains how teacher data is handled...",
      createdAt: "2023-06-26",
    },
  ]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3>{selectedRow?.id ? "Edit Policy" : "Add New Policy"}</h3>
          <TextField
            label="Title"
            variant="outlined"
            size="small"
