...
const DoubtManagement = () => {
  ...
  const [tickets, setTickets] = useState([
    {
      ...
      ticketid: "#TC-192",
      subject:"Physics",
      doubttitle: "Unrecognized Charges on My Account",
      priority: "High",
    ...
    },
    {
      ...
      ticketid: "#TC-191",
      subject:"Math",
      doubttitle: "Defective Item Received",
      priority: "Low",
  ...
  const columns = [
    ...
    { field: "ticketid", headerName: "Batch Name", flex: 1 },
    { field: "subject", headerName: "Subject", flex: 2 },
    { field: "doubttitle", headerName: "Doubt Title", flex: 2 },
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (params) => (
        <Box display="flex" gap="10px"   style={{margin:"10px"}}    >
          <Button
            variant="contained"
            size="small"
            sx={{
